...
[![image](https://img.shields.io/pypi/v/ruff/0.6.0.svg)](https://pypi.python.org/pypi/ruff)
[![image](https://img.shields.io/pypi/l/ruff/0.6.0.svg)](https://pypi.python.org/pypi/ruff)
[![image](https://img.shields.io/pypi/pyversions/ruff/0.6.0.svg)](https://pypi.python.org/pypi/ruff)
...
To avoid running on Jupyter Notebooks too, remove `jupyter` to the list of allowed filetypes:
